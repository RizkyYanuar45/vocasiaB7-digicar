...
function CreateModal({ isOpen, onClose, onTestimoniCreated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://v1.digicar.my.id/api/testimoni', formData, {
        headers: {
          ...
          <form className="p-4 md:p-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 mb-4 grid-cols-2">
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <p className="text-sm text-gray-500 mt-2">{rating > 0 ? `You gave ${rating} star(s)` : 'No rating selected'}</p>
              </div>
              ...
              <div className="col-span-2 sm:col-span-2">
                <label htmlFor="comment" className="block mb-2 text-sm font-medium text-text">
                  Comment
                </label>
                <input
                  type="text"

  ...
  return (
    <div>
      ...
      <div className="md:hidden fixed top-0 left-0 z-50 w-full bg-primary">
        ...
        {/* Menu Mobile */}
        {isOpen && (
          <ul className="flex flex-col text-white font-main bg-primary space-y-2 px-4 py-2">
            {[
              { name: "Dashboard", path: "/admin/dashboard", icon: <Bolt /> },
              { name: "Car Option", path: "/admin/car", icon: <Car /> },
              { name: "Konten Blog", path: "/admin/blog", icon: <Newspaper /> },
            ...
            {/* Log Out */}
            <li className="mt-1 mb-5 w-full flex justify-center items-center">
              <button className="flex items-center space-x-2 px-4 w-full py-2 border border-secondary text-white rounded hover:text-gray-900 hover:bg-secondary transition-all duration-300">
                <span className="w-6 flex justify-center">
                  <LogOut />
                </span>
                <span>Log Out</span>

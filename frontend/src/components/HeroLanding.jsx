          ...
          <div className="flex gap-5 max-md:flex-col">
            <div className="flex flex-col w-[58%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
                <div className="flex flex-col pr-8 pl-3 max-md:pr-5 max-md:max-w-full animate__animated animate__slideInLeft">
                  <br />
                ...
                <div className="py-3 pr-9 pl-3 mt-36 w-full bg-white rounded-3xl border border-black border-solid max-md:pr-5 max-md:mt-10 max-md:max-w-full">
                  <div className="flex gap-5 max-md:flex-col animate__animated animate__slideInLeft">
            ...
            <div className="flex flex-col ml-5 w-[30%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-start pt-32 pb-52 bg-gradient-to-b from-rose-800 to-white-100  rounded-[50px_50px_0px_0px] max-md:py-24 max-md:mt-10 max-md:max-w-full animate__animated animate__slideInRight">
                <img
                  loading="lazy"

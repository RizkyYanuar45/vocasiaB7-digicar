...
export const Contact = () => {
  ...
  return (
    <div className="flex flex-col w-screen bg-red-500">
      ...
      <section className="relative w-full max-w-full overflow-hidden text-text pt-16 md:pt-0">
        <div className="bg-secondary relative shadow-md overflow-hidden lg:ml-44">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-2 p-4 bg-primary">
            <div onClick={() => handleOpenEditModal(contact)} className="flex items-center w-fit p-3 bg-blue-700 text-white-50 rounded-xl justify-center cursor-pointer">
                  ...
                  contact && (
                    <>
                      ...
                      <tr className="border-b border-black">
                        ...
                        <td className="px-2 py-1 truncate">{contact.instagram}</td>
                      </tr>
                      <tr className="border-b border-black">
                        <td className="px-2 py-1 truncate">Facebook</td>
                        <td className="px-2 py-1 truncate">{contact.facebook}</td>
                      </tr>
                      <tr className="border-b border-black">
                        <td className="px-2 py-1 truncate">YouTube</td>
                        <td className="px-2 py-1 truncate">{contact.youtube}</td>
                      </tr>
                      <tr className="border-b border-black">
                        <td className="px-2 py-1 truncate">Twitter</td>
                        <td className="px-2 py-1 truncate">{contact.twitter}</td>
                      </tr>
                      <tr className="border-b border-black">
                        <td className="px-2 py-1 truncate">LinkedIn</td>
                        <td className="px-2 py-1 truncate">{contact.linkedln}</td>
                      </tr>
                      <tr className="border-b border-black">
                        <td className="px-2 py-1 truncate">Admin 1</td>
                        <td className="px-2 py-1 truncate">{contact.admin_one}</td>
                      </tr>
                      <tr className="border-b border-black">
                        <td className="px-2 py-1 truncate">Admin 2</td>
                        <td className="px-2 py-1 truncate">{contact.admin_two}</td>
                      </tr>
                      <tr className="border-b border-black">
      ...
      {/* Modal */}
      <EditModal isOpen={isEditModal} onClose={handleCloseEditModal} contactData={selectedContact} />
    </div>
  );
};

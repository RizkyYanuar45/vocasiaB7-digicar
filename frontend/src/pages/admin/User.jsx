      ...
      <div className="bg-secondary lg:ml-44 min-h-screen">
        <div className="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full max-w-lg my-1 mt-32">
            ...
            <input type="text" className="w-full rounded-lg border border-primary mt-3 p-4 text-sm shadow-sm bg-white" placeholder="Name" value={newName} onChange={(e) => setNewName(e.target.value)} />
          </div>
          ...
          <div className="w-full max-w-lg my-1">
            ...
            <input type="email" className="w-full rounded-lg border border-primary mt-3 p-4 text-sm shadow-sm bg-white" placeholder="Email" value={newEmail} onChange={(e) => setNewEmail(e.target.value)} />
          </div>
          ...
          <div className="w-full max-w-lg my-1">
            ...
            <div className="relative">
              ...
              />
              <button type="button" onClick={togglePassword} className="absolute right-3 top-1/2 transform -translate-y-1/2" aria-label={showPassword ? 'Hide password' : 'Show password'}>
                {showPassword ? '🙈' : '👁️'}
              </button>
            </div>
          </div>
          ...
          {/* Edit Button */}
          <button className="w-full max-w-lg mt-5 rounded-lg bg-primary px-5 py-1 text-sm font-medium text-white-50 flex font-inter items-center justify-center" onClick={handleEdit}>

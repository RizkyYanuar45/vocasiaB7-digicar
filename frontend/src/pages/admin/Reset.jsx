    ...
    <div className="lg:flex-row flex flex-col bg-secondary min-h-screen overflow-hidden">
      ...
      >
        <h1 className="font-main font-bold text-3xl lg:text-4xl pt-8 lg:pt-16 px-5 text-text text-center lg:text-left">
          {step === "request" ? "Kirim Kode Reset" : "Reset Password"}
        </h1>

        <form
          onSubmit={
            step === "request" ? handleRequestResetCode : handleResetPassword
          }
        ...
        >
          {step === "request" && (
            <div className="flex flex-col w-full max-w-lg">
              ...
              <button
                type="submit"
                className="bg-primary text-white-50 p-3 mt-6 rounded-lg w-full"
                disabled={loading}
              >
          ...
          {step === "reset" && (
            <>
              ...
              <button
                type="submit"
                className="bg-primary text-white-50 p-3 mt-6 rounded-lg w-1/2"
                disabled={loading}
              >
